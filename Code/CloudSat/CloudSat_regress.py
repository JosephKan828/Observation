...
with xr.open_dataset("/work/b11209013/2025_Research/CloudSat/CloudSat_sub/qlw.nc") as f:
    # f = f.sel(lon=slice(central_lon-100, central_lon+100))
...
with h5py.File(f"/home/b11209013/2025_Research/Obs/Files/OLR/olr_mjo_k_{k_domains[0]}_{k_domains[1]}.h5", "r") as f:
    ...
    olr = np.array(f.get("reconstruct_olr"))[:, lon_tar]
...
# 4. save file
#######################
# with h5py.File(f"/home/b11209013/2025_Research/Obs/Files/OLR/Corr/corr_kw_k_{k_domains[0]}_{k_domains[1]}_lon={central_lon}.h5", "w") as f:
with h5py.File(f"/home/b11209013/2025_Research/Obs/Files/OLR/Corr/corr_mjo_k_{k_domains[0]}_{k_domains[1]}_lon={central_lon}.h5", "w") as f:
