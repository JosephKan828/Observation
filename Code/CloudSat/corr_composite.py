...
# plt.title("Correlation between LW and KW OLR (composite)", fontsize=20)
...
plt.tight_layout()
# plt.savefig(f"/home/b11209013/2025_Research/Obs/Figure/OLR_corr/qlw_kw_k_{k_domains[0]}_{k_domains[1]}_compsite.png", dpi=300)
plt.savefig(f"/home/b11209013/2025_Research/Obs/Figure/OLR_corr/qlw_mjo_k_{k_domains[0]}_{k_domains[1]}_composite.png", dpi=300)
plt.close()
...
plt.xlabel("Longitude (degree)", fontsize=18)
plt.ylabel("Level (hPa)", fontsize=18)
# plt.title("Correlation between SW and KW OLR (composite)", fontsize=20)
...
cb.ax.tick_params(labelsize=16)
plt.tight_layout()
# plt.savefig(f"/home/b11209013/2025_Research/Obs/Figure/OLR_corr/qsw_kw_k_{k_domains[0]}_{k_domains[1]}_compsite.png", dpi=300)
plt.savefig(f"/home/b11209013/2025_Research/Obs/Figure/OLR_corr/qsw_mjo_k_{k_domains[0]}_{k_domains[1]}_composite.png", dpi=300)
plt.close()